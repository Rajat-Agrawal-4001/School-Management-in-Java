...
public class Faculty_Profile implements  ActionListener{
    ...
    public Faculty_Profile () {
        frame = new JFrame();
        frame.setTitle("Faculty Profile");
        ...
        label6.setFont(new Font("Arail", Font.PLAIN, 14));
        ...
        label17= new JLabel("Rohit");
        label17.setHorizontalAlignment(SwingConstants.CENTER);
        label17.setBorder(new LineBorder(new Color(192, 192, 192)));
        label17.setFont(new Font("Arail", Font.BOLD, 14));
        ...
        label27.setFont(new Font("Arail", Font.BOLD, 14));
        label27.setBackground(Color.LIGHT_GRAY);
        mainPanel.add(label27);
        label27.setBounds(271, 560, 300, 30);

        label28= new JLabel("Rohit");
        label28.setFont(new Font("Arail", Font.BOLD, 16));
        label28.setBackground(Color.WHITE);
        label28.setForeground(Color.WHITE);
        panel1.add(label28);
        label28.setBounds(785, 50, 250, 30);

        ImageIcon img2 = new ImageIcon(ClassLoader.getSystemResource("com\\images\\avatar.jpg"));
        Image myimage1 = img2.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
        label14= new JLabel(new ImageIcon(myimage1));
        mainPanel.add(label14);
        label14.setBounds(745, 128, 150, 150);

        id=Faculty_Details.faculty_id;
        String roll_number="";
        String photo="";
        try {
            ...
            if(resultSet.next()) {
                label17.setText(resultSet.getString("faculty_name"));
                label16.setText((String)resultSet.getString("faculty_id"));
                label18.setText(resultSet.getString("position"));
                photo=resultSet.getString("photo");
                label19.setText(resultSet.getString("address"));
                label20.setText(resultSet.getString("email"));
                label27.setText(resultSet.getString("join_date"));
                label22.setText(resultSet.getString("phone_number"));
                label23.setText(resultSet.getString("qualification"));
                label25.setText(resultSet.getString("gender"));;
                label26.setText(resultSet.getString("experience"));
                label21.setText(resultSet.getString("dob"));
                label28.setText(resultSet.getString("faculty_name"));
            }
            con.c.close();
        }
        catch(Exception e){
        ...
        ImageIcon img3 = new ImageIcon(ClassLoader.getSystemResource("com\\images\\"+photo+""));
        Image myimage2 = img3.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
